...
- **Participant management** — add / edit / search / delete, categories (Children, Adults, Open), participant profile with full game history.
...
| Model | Key Fields |
|---|---|
| **Participant** | name, age, category (Children/Adults/Open), contactName, contactPhone, year, notes |
